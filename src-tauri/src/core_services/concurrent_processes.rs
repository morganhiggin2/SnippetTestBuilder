...
pub async fn spawn_initialize_directory_event(application_state: Arc::<Mutex::<ApplicationState>>, mut logging_stream_instance: LoggingStreamInstance, app_handle: tauri::AppHandle) {
