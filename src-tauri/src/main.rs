...
use crate::tauri_services::snippet_tauri_service::{new_snippet, validate_pipeline_connection, get_snippet_information, new_pipeline, check_pipeline_connector_capacity_full, get_id};
...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![logln, new_window_session, get_snippet_directory, new_snippet, get_snippet_information, validate_pipeline_connection, new_pipeline, check_pipeline_connector_capacity_full, get_id])
