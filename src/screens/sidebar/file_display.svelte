<script>
    ...
    //files to sidebar
    let files = [
        {id: 0, name: "CustomProject", level: 0, file: false, showing: false},
        {id: 1, name: "src", level: 1, file: false, showing: false},
        {id: 2, name: "main.rs", level: 2, file: true, showing: false},
        {id: 3, name: "write module {}", level: 3, file: true, showing: false}
    ];
